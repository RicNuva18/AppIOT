...
public class RutaDos extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerDragListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //PARA GOOGLE MAPS
        //ubicUsuario=getIntent().getStringExtra("ubicacionUsuario");
        //Log.e(">>>", "DATO: " + ubicUsuario.toString());
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapRutaDos);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(ediL).title("Edificio L").snippet("Aquí esta su carro").icon(BitmapDescriptorFactory.fromResource(R.drawable.edificio)));
